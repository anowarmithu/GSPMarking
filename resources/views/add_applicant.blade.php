              ...
              @csrf
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" id="applicant_name" name="applicant_name" placeholder="applicant name">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="number" class="form-control" id="primary_mobile" name="primary_mobile" placeholder="primary mobile">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="number" class="form-control" id="mobile_02" name="mobile_02" placeholder="secondery mobile">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" id="justification" name="justification" placeholder="type here.."></textarea>
                  ...
                  <!-- other_disability -->
                  <div class="form-group col-md-3">
                    <label for="other_disability">Other Disabilities</label>
                    <select id="other_disability" class="form-control" name="other_disability">
                      <option selected>Select</option>
                      @foreach ($data['disabilities'] as $item)
                      <option>{{ $item }}</option>
                      @endforeach
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="thana_police_station" name="thana_police_station" placeholder="thana_police_station">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="monthly_income" name="monthly_income" placeholder="monthly_income">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="monthly_expense" name="monthly_expense" placeholder="monthly_expense">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="family_asset" name="family_asset" placeholder="family_asset">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="family_monthly_income" name="family_monthly_income" placeholder="family_monthly_income">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="hsc_result" name="hsc_result" placeholder="hsc_result">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="ssc_result" name="ssc_result" placeholder="ssc_result">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="name" class="form-control" id="class9to12_hifj" name="class9to12_hifj" placeholder="class9to12_hifj">
